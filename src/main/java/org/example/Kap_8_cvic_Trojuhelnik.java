...
public class Kap_8_cvic_Trojuhelnik {
    ...
    public Kap_8_cvic_Trojuhelnik(int stranaA, int stranaB, int stranaC) {
        ...
        //pøepona = stranaA > stranaB ? (stranaA > stranaC ? stranaA : stranaC) : (stranaB > stranaC ? stranaB : stranaC);
    ...
    public Kap_8_cvic_Trojuhelnik(int jednaStrana) {
        ...
        this(jednaStrana, jednaStrana, jednaStrana); //není-li na zaèátku => java: call to this must be first statement in constructor
    }
    ...
    public static void main(String[] args) {
        ...
        //celoèíselný pravoúh. 3úhelník: 3; 4; 5 // 5; 12; 13 // 8; 15; 17 // 7; 24; 25 // ...
