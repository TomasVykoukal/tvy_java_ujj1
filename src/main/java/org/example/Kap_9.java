...
public class Kap_9 {
    ...
    public static void main(String[] args) {
        ...
        //ostatní zpùsoby vytvoøení obj. øetìzce pomocí konstruktorù a jejich výpis
        byte[] bajty = {(byte)'E', (byte)'v', (byte)'a'}; //pole bajtù
        char[] znaky = {'M', 'a', 'r', 't', 'i', 'n', 'a'}; //pole znakù
        StringBuffer buf = new StringBuffer("Dobrý den!"); //"mìnitelný" øetìzec

        System.out.println("(" + bajty.length + "): " + bajty[0] + " " + bajty[1] + " " + bajty[2]); //-->69 118 97 (pøímý výstup => èíselná interpretace)
        ...
        //práce s celými øetìzci - porovnávání
        ...
        //práce s celými øetìzci - pøevody na malá èi velká písmena
        String s3 = "malá a VELKÁ (©tiøín áèïéìíµòàø¹»úùý¾ ÁÈÏÉÌÍ¥ÒÀØ©«ÚÝ®)";
        System.out.println("s3:               " + s3);
        System.out.println("s3.toLowerCase(): " + s3.toLowerCase());
        System.out.println("s3.toUpperCase(): " + s3.toUpperCase());
        System.out.println();

        //práce s celými øetìzci - spojení øetìzcù
        String s3_1 = "malá a ";
        String s3_2 = "VELKÁ";
        ...
        //práce s celými øetìzci - náhrada v¹ech znakù v øetìzci
        ...
        s5_3 = s5_1.substring(5, 9); //dùle¾ité: koncový index ukazuje na index PRVNÍHO NEPOU®ITÉHO znaku ("endIndex: the ending index, exclusive")
        ...
        //oøíznutí bílých znakù na okrajích
        String s6_2, s6_1 = "\r\n\t ahoj\t \r\n";
        s6_2 = s6_1.trim();
        ...
        //práce s jednotlivými znaèky øetìzce - viz charAt()
        ...
        System.out.print("5 desetinných míst: " + s_d8);
        ...
        //Tøída stringBuffer - "mìnitelný øetìzec"
        System.out.print("\\u0000: ");
        System.out.println('\u0000');
        ...
        //pøevod jednotlivých znakù na èísla
